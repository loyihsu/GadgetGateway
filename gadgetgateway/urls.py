...
urlpatterns = [
    ...
    path('category/<slug:category_name_slug>/<slug:product_name_slug>/dislike/', views.dislike_product, name='dislike_product'),
    path('category/<slug:category_name_slug>/<slug:product_name_slug>/undo_reactions/', views.undo_reactions, name='undo_reactions'),
